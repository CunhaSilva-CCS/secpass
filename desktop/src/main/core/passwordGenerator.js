// Porta de src/utils/passwordGenerator.js (app mobile): mesma logica de
// geracao (CSPRNG com rejection sampling pra evitar vies), troca
// QuickCrypto.randomBytes por crypto.randomBytes do Node.
