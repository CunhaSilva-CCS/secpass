// Copia identica de src/utils/loginThrottle.js (app mobile) - logica pura
// de bloqueio progressivo, agnostica de plataforma. Nao alterar sem
// replicar la.
//
// LIMITACAO ACEITA (achado de seguranca, severidade media): compara
// `lockUntil` contra `Date.now()`, o relogio do proprio sistema - sem
// servidor, nao ha como impor um limite real. Quem tem acesso fisico ao
// computador desbloqueado pode adiantar o relogio do sistema pra pular a
// espera. A defesa real contra forca bruta e o custo computacional do
// PBKDF2 (600 mil iteracoes, ver vaultCrypto.js), nao este contador.
